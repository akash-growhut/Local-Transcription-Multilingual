...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onMicrophoneConnected: (callback) => ipcRenderer.on('microphone-connected', (event, value) => callback(value)),
  onSpeakerConnected: (callback) => ipcRenderer.on('speaker-connected', (event, value) => callback(value)),
  onMicrophoneError: (callback) => ipcRenderer.on('microphone-error', (event, error) => callback(error)),
